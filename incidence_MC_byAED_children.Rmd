...
subtitle: "children (AGE <= 16), patients with incident Main-CM only, new IXDAYS"
...
PATIENTS_AGE_REGION <- FILTER_PATIENTS_AGE_REGION.T2(TABLE04.2, cohort = "children")
