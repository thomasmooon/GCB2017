...
MAIN.COMORB.PHEWAS[is.na(MAIN.COMORB.PHEWAS)] <- 0
...
survminer::ggsurvplot(KM, pval = TRUE, risk.table = TRUE, ylim = c(0.75,1), main = "kaplan meier estimates of incident main-comorbidities \n children")
```
...
MC               <- gsub("Developmental","Developmental.delays.and.disorders", MC)
