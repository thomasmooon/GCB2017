...
fo.drug2tissue        <- spread(data.frame(fo.drug2tissue,key=1), tissue, key, fill = 0, sep = ".x.")
...
fo.drug2sideeffects <- unite(fo.drug2sideeffects, SIDEEFFECTxFREQ, SIDEEFFECTS, WHO, sep=".x.")
fo.drug2sideeffects <- spread(data.frame(fo.drug2sideeffects,key=1), SIDEEFFECTxFREQ, key, fill = 0, sep = ".x.")
