...
goEnrMF <- mclapply(disease2genes.enr, FUN = function(genes) GoEnrichment(genes, universe$ENTREZID, "MF"), mc.preschedule = FALSE, mc.cores = 1)
goEnrCC <- mclapply(disease2genes.enr, FUN = function(genes) GoEnrichment(genes, universe$ENTREZID, "CC"), mc.preschedule = FALSE, mc.cores = 1)
