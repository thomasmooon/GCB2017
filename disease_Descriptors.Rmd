...
disease2path.enr <- mclapply(disease2genes.enr, FUN = function(x) (PathEnrichment(x, kegg2entrez))[,1], mc.preschedule = FALSE, mc.cores = 15)
...
disease2path.enr <- mclapply(disease2genes.enr, FUN = function(x) (PathEnrichment(x, entrez2wiki))[,1], mc.preschedule = FALSE, mc.cores = 15)
disease2path.enr <- lapply(disease2path.enr, as.character)
